...
import Mentor from "/public/assets/icon/pensile3.svg";

import Close from "/public/assets/icon/delete4.svg";
...
export const MentorAdminPage: React.FC<Props> = ({}) => {
  return (
          ...
          <div key={nex.id} className="flex space-y-10 items-center space-x-4">
            <div className="flex p-3 mb-10 shadow-md rounded-sm items-center justify-between border w-[924px] h-auto  gap-5">
              ...
              <div className="flex justify-end items-center gap-20">
                <div className="cursor-pointer p-2 hover:bg-slate-100 border shadow-sm">
                  <Image
                    src={Mentor}
                    alt="img"
                ...
                <div className="border p-2 hover:bg-slate-100 shadow-sm cursor-pointer">
